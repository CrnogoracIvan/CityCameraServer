...
var transports = [
  new (winston.transports.Console)({
    level: process.env.NODE_PPS_LOG_LEVEL || "debug",
...
if (!process.env.PPS_TEST) {
  if (config.log.logsToDatabase) {
    transports.push(new (winston.transports.MongoDB)(config.log.DB));
  }
